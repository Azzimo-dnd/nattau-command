...
export async function loadCommandCenterData(options: {
  campaignId: string;
  campaignSlug: string;
  ...
  const { data: sessionData, error: sessionError } = await supabase
    ...
    .select("status, next_session_at, message, debuffs")
