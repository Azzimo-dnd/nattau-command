-- ============================================================
-- Campaign Companion — Multi-Campaign Administration & Onboarding v2
--
-- Adds:
...
-- Safe to run after the Barovia-only v1 migration; functions are replaced
-- and existing invitation/member data is preserved.
-- ============================================================
...
left join public.profiles p on p.id = cm.user_id
order by c.sort_order, c.slug, cm.role, p.display_name;
